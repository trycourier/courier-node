...
* **api:** add cancelation_token to journey create, replace, and get ([#306](https://github.com/trycourier/courier-node/issues/306)) ([65e6c2d](https://github.com/trycourier/courier-node/commit/65e6c2d496065dfbf0a756222edb1a7357769859))


### Documentation

* **api:** correct the digest schedule contract, and make `schedules` optional ([#303](https://github.com/trycourier/courier-node/issues/303)) ([e0a29dc](https://github.com/trycourier/courier-node/commit/e0a29dc4f0f72aa724f1771034e7b676b12d2740))
...
* **api:** document the channel-block requirement on template creation ([#293](https://github.com/trycourier/courier-node/issues/293)) ([f1874d4](https://github.com/trycourier/courier-node/commit/f1874d418fb3cbe24a992ede68b9650bc109a8b6))
...
* **api:** give Elemental nodes their properties in every SDK ([#287](https://github.com/trycourier/courier-node/issues/287)) ([4e997d7](https://github.com/trycourier/courier-node/commit/4e997d7b16925d77a85c235369185e97d4f62d69))

## [9.4.0](https://github.com/trycourier/courier-node/compare/v9.3.0...v9.4.0) (2026-08-28)


### Features

* **api:** document channel on journey send nodes [C-20309] ([#285](https://github.com/trycourier/courier-node/issues/285)) ([1cbeecf](https://github.com/trycourier/courier-node/commit/1cbeecf786c9bd2f4440e49a41bd9386b4d31b4f))
...
* **api:** give every request body an example, and correct the archive status code ([#270](https://github.com/trycourier/courier-node/issues/270)) ([08bd781](https://github.com/trycourier/courier-node/commit/08bd781ef024278f1412920df0e186dda11937dc))
...
* Merge pull request [#183](https://github.com/trycourier/courier-node/issues/183) from trycourier/dantran/c-19684-api-spec-document-messagecontexttenant_id-on-journey-send ([1c54190](https://github.com/trycourier/courier-node/commit/1c5419068170f85ea9d166d836a20f8d6b570a95))
* spec: remove inbox message delete/restore endpoints for now (C-19268) ([#182](https://github.com/trycourier/courier-node/issues/182)) ([b39bd43](https://github.com/trycourier/courier-node/commit/b39bd435dee66814841cd8148b3f45eee8757302))
* spec: reorder API reference sections to match the Studio nav ([#180](https://github.com/trycourier/courier-node/issues/180)) ([836db11](https://github.com/trycourier/courier-node/commit/836db116517ec16538aef9431f57c874cd2c3dc5))
