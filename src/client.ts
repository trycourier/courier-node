...
export declare namespace Courier {
  ...
  export type ElementalActionNode = API.ElementalActionNode;
  ...
  export type ElementalDividerNode = API.ElementalDividerNode;
  export type ElementalDividerNodeWithType = API.ElementalDividerNodeWithType;
  export type ElementalHTMLNode = API.ElementalHTMLNode;
  export type ElementalHTMLNodeWithType = API.ElementalHTMLNodeWithType;
  export type ElementalImageNode = API.ElementalImageNode;
  ...
  export type Locales = API.Locales;
