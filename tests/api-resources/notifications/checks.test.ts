...
describe('resource checks', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.notifications.checks.update('submissionId', { id: 'id', checks: [{
    id: 'id',
    status: 'RESOLVED',
    type: 'custom',
  }] });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.notifications.checks.update('submissionId', { id: 'id', checks: [{
    id: 'id',
    status: 'RESOLVED',
    type: 'custom',
  }] });
